...
module.exports = class Ejercicio {
    ...
    save() {
        return db.execute(
            ...
            [this.categoria, this.nivel_intensidad, this.referencia_visual, this.descripcion_ejercicio, this.nombre_ejercicio, this.imagen_ejercicio]
        );
    }
    ...
    static fetchById(id_ejercicio) {
        return db.execute('SELECT * FROM ejercicio WHERE id_ejercicio = ?', [id_ejercicio]);
    }
    ...
    update() {
        return db.execute(
            ...
            [this.categoria, this.nivel_intensidad, this.referencia_visual, this.descripcion_ejercicio, this.nombre_ejercicio, this.imagen_ejercicio, this.id_ejercicio]
        );
    }

    static deleteById(id_ejercicio) {
        return db.execute('DELETE FROM ejercicio WHERE id_ejercicio = ?', [id_ejercicio]);
    }
}
