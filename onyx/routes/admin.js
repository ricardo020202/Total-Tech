...
router.get('/admindashboard/programas/editar-programa', checkPrivilegio('Modificar programa'),
             adminController.getAdminEditarPrograma);

router.post('/admindashboard/programas/editar-programa', checkPrivilegio('Modificar programa'),
